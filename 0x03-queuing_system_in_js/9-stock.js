...
/**
 * changes the reserved stock for a given item.
 * @parameter {number} itemId - The id of the item.
 * @parameter {number} stock - The stock of the item.
 */
...
/**
 * Recover the reserved stock for a given item.
 * @parameter {number} itemId - The id of the item.
