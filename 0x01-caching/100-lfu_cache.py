#!/usr/bin/env python3
"""Least Frequently Used caching approached.
"""
...
class LFUCache(BaseCaching):
    """Reps an object that allow stores and
    recovers items from a dictionary with a LFU
    rm -r mechanism when the limit is attends.
    """
    def __init__(self):
        """set-up the cache.
        """
